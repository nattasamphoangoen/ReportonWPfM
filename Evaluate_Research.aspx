<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Evaluate_Research.aspx.cs" Inherits="Evaluate_Research" Async="true" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <table align="center" width="768" class="gray">
                            ...
                            <tr class="lead">
                                <td colspan="6" align="center" class="txt_title_rewards">งานวิจัย (ภาควิชาการ, ภาคอุตสาหกรรม)</td>
                            </tr>
                            <tr>
                                <td colspan="6">&nbsp;
                                </td>
