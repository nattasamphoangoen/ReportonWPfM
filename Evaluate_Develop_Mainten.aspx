<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Evaluate_Develop_Mainten.aspx.cs" Inherits="Evaluate_Develop_Mainten" Async="true" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <table align="center" width="768" class="gray">
                            ...
                            <tr class="lead">
                                <td colspan="6" align="center" class="txt_title_rewards">งานพัฒนาและบำรุงรักษาระบบลำเลียงแสง หรือสถานีทดลอง หรือห้องปฎิบัติการต่างๆ (Development and Maintenance)</td>
                            </tr>
                            <tr>
                                <td colspan="6">&nbsp;
                                </td>
