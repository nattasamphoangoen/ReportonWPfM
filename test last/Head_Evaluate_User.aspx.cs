...
public partial class Head_Evaluate_User : System.Web.UI.Page {
    ...
    protected void btReset_Click (object sender, EventArgs e) {
        ...
        Response.Redirect ("Head_Evaluate_User.aspx");
    }
    ...
    protected void bt_EditRound_Click (object sender, EventArgs e) {
        ...
        Response.Redirect ("Head_Evaluate_Index.aspx?nID=" + rId);
    }

    protected void bt_SentRound_Click (object sender, EventArgs e) {
        GridViewRow row = ((GridViewRow) ((Button) sender).NamingContainer);
        string rId = gvData.DataKeys[row.RowIndex]["MId"].ToString ();
        //string rId = Request.QueryString["nId"];
        Response.Redirect ("Head_Evaluate_User.aspx?nID=" + rId);
    }
