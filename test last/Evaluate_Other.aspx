<%@ Page Title="EvaluateOther" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Evaluate_Other.aspx.cs" Inherits="Evaluate_Other" Async="true" %>
                                        ...
                                        <asp:GridView ID="gvData2" runat="server" Width="900px" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="เอกสารคำสั่ง" ShowHeader="False"
                                                    ...
                                                    <ItemStyle Width="100px" Font-Size="Small" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload7_2" runat="server" Visible="False"
                                        ...
                                        <asp:GridView ID="gvData3" runat="server" Width="900px" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="เอกสารคำสั่ง " ShowHeader="False"
                                                    ...
                                                    <ItemStyle Width="80px" Font-Size="Small" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload7_3_1" runat="server" Visible="False"
                                                ...
                                                <asp:TemplateField HeaderText="เอกสาร TOR" ShowHeader="False"
                                                    ...
                                                    <ItemStyle Width="80px" Font-Size="Small" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload7_3_2" runat="server" Visible="False"
                                        ...
                                        <asp:GridView ID="gvData4" runat="server" Width="900px" AllowPaging="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="เอกสารคำสั่งและตารางการปฏิบัติงาน"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDownload7_4" runat="server" Visible="False"
                    ...
                    <asp:UpdatePanel ID="UpdatePanel7_4" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="modalPopup" style="padding: 10px;">
                                <div class="com_address">
                                    <div class="headline" style="text-align: center">
                                        <strong style="color: #593b00">คณะกรรมการ</strong>
                                        <strong style="color: #ff0000">ตรวจนับ</strong>
                                        <strong style="color: #593b00">พัสดุ</strong></div>
                                    <table align="center" width="100%" class="gray">
