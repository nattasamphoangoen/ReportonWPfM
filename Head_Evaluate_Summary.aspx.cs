...
using ClassLibrary;
//2
public partial class Head_Evaluate_Summary : System.Web.UI.Page {
    //=============================DevelMaint2_1 =================================================
    ...
    protected void report5_Click (object sender, EventArgs e) {
        string rId = Request.QueryString["nId"];
        Response.Redirect ("~/Head_Evaluate_AcademicServices.aspx?nID=" + rId);
   ...
   protected void SearchData () {
        string sql = @"select M.id , 
				...
				isnull(ES6_2.score6_2,0) AS score6_2,
                ...
                INNER JOIN Account AS A ON A.id = M.acountId
                INNER JOIN ProjectControl AS C ON C.id = M.roundId
                WHERE M.acountId = ES1_1.createdBy AND ES1_1.masterId = @MasterId";
