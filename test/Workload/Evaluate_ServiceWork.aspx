...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        <tr class="lead">
            <p colspan="5" align="center" class="txt_title_rewards">1. งานให้บริการ (ภาควิชาการ, ภาคอุตสาหกรรม)</p>
        </tr>
         <tr>
            <td>&nbsp;</td>                                               
         </tr>
        ...
        <ContentTemplate>
            <table align="center" width="100%">
                <tr>
                    <h5 class = "h5" align="left" >1. งาน Local contact (Experimental setup, Sample preparation, and Measurement) งานสอบเทียบเครื่องมือและมาตรฐานการวัด</h5>
                </tr>
                <tr>
                               ...
                               <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditSevice" runat="server" Text=''
                                            ...
                                            <img id="editService" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_edit_16x16_9821.gif"
                                        width="16" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                 ...
                                 <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeletService" runat="server" Text=''
                                            ...
                                            <img id="DeletService" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_trash_(delete)_16x16_10030.gif"
                                        width="16" />
                                        </asp:LinkButton>
                ...
                <tr>
                    <td colspan="6" align="right">
                        <asp:Button ID="Add1_1" runat="server" CssClass="btn btn-success" 
                            Text="Add" OnClick="Add1_1_Click"/>
                    </td>
                </tr>
                        ...
                        <table align="center" width="100%" class="gray">
                            ...
                            <tr>
                                ...
                                <td valign="top" align="right">
                                    <span style="color: Red">*</span> <strong style="color: #003359">หมายเลขโครงการ :</strong>
                                </td>
                            ...
                            <tr>
                                <td valign="top" align="right">
                                    <span style="color: Red">*</span> <strong style="color: #003359">ชื่อโครงการ :</strong>
                                </td>
                                <td valign="top" width="150" colspan="3">
                           ...
                           <tr> 
                            <td align="right" valign="top">
                             ...
                             <tr>
                                <td valign="top" align="right">
                                    <span style="color: Red">*</span> <strong style="color: #003359">จำนวน Shift :</strong>
                                </td>
                                <td valign="top" width="150" colspan="3">
                            ...
                            <tr>
                                <td align="center" colspan="6">
                                    <asp:Label ID="lblInError1_1" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="6" valign="top">
                                    <asp:Button ID="btnAddService" runat="server" CssClass="txt_howtonav" Text="Submit"
                                        Width="100px" ValidationGroup="AddColor" OnClick="btnAddService_Click" />
                                    <cc1:ConfirmButtonExtender ID="btnAddService_ConfirmButtonExtender"
                                    ...
                                    <asp:Button ID="btnCancel" runat="server" CausesValidation="False" CssClass="txt_howtonav"
                                        Text="Cancel" Width="100px" OnClick="btnCancelService_Click" />
                                </td>
                            </tr>
                        </table>
                    </div>
...
<div>
        ...
        <ContentTemplate>
            <table align="center" width="100%">
                               ...
                               <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditSevice2" runat="server" Text=''
                                            ...
                                            <img id="editService2" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_edit_16x16_9821.gif"
                                        width="16" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                 ...
                                 <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeletService2" runat="server" Text=''
                                            ...
                                            <img id="DeletService2" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_trash_(delete)_16x16_10030.gif"
                                        width="16" />
                                        </asp:LinkButton>
                ...
                <tr>
                    <td colspan="6" align="right">
                        <asp:Button ID="Add1_2" runat="server" CssClass="btn btn-success" 
                            Text="Add" OnClick="Add1_2_Click"/>
                    </td>
                </tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1_2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modalPopup" style="padding: 10px;">
                    <div class="com_address">
                        <div class="headline" style="text-align: center">
                            <strong style="color: #593b00">เพิ่มข้อมูลงานให้บริการภาคอุตสาหกรรม</strong></div>
                        <table align="center" width="100%" class="gray">
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="3">
                                    <asp:TextBox ID="txtProjectCode2" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectCode2Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectCode2"
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="3">
                                    <asp:TextBox ID="txtProjectName2" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectName2Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectName2"
                                        Display="Dynamic" SetFocusOnError="True" ValidationGroup="AddServeice1_2"></asp:RequiredFieldValidator>
                                </td>
                            </tr>      
                           ...
                           <tr> 
                            <td align="right" valign="top">
                             ...
                             <tr>
                                ...
                                <td valign="top" width="150" colspan="3">
                                    <asp:TextBox ID="txtProjectShift2" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectShift2Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectShift2"
                                        Display="Dynamic" SetFocusOnError="True" ValidationGroup="AddServeice1_2"></asp:RequiredFieldValidator>
                                </td>
                            </tr>  
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="6">
                                    <asp:Label ID="lblInError1_2" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="6" valign="top">
                                    <asp:Button ID="btnAddService2" runat="server" CssClass="txt_howtonav" Text="Submit"
                                        Width="100px" ValidationGroup="AddColor" OnClick="btnAddService_Click2" />
                                    <cc1:ConfirmButtonExtender ID="btnAddService2_ConfirmButtonExtender" 
                                        runat="server" ConfirmText="ยืนยันการบันทึกข้อมูล" Enabled="True" 
                                        TargetControlID="btnAddService2">
                                    </cc1:ConfirmButtonExtender>
                                    <asp:Button ID="btnCancel2" runat="server" CausesValidation="False" CssClass="txt_howtonav"
                                        Text="Cancel" Width="100px" OnClick="btnCancelService_Click2" />
                                </td>
                            </tr>
                        </table>
                    </div>
...
//###############################EvaluateSevice1_3 Strat##################################################### --%>
 ...
 <div>
        ...
        <ContentTemplate>
            <table align="center" width="100%">
                <tr>
                    <h5 class = "h5" align="left" >3. งานเป็นที่ปรึกษาให้กับผู้ใช้บริการแสงซินโครตรอน / ภาคอุตสาหกรรม</h5>
                </tr>
                <tr>
                    <td colspan="6" align="Left">
                        <asp:GridView ID="gvData3" runat="server" Width="900px" AllowPaging="True" OnPageIndexChanging="gvData_PageIndexChanging3"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="รายละเอียด/ผลลัพธ์ที่ให้บริการ" DataField="projectDescription" ItemStyle-Width="80px" >
                                    <ItemStyle Width="100px" Font-Size="Small" />
                                </asp:BoundField>
                               ...
                               <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditSevice3" runat="server" Text=''
                                            ...
                                            <img id="editService3" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_edit_16x16_9821.gif"
                                        width="16" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                 ...
                                 <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeletService3" runat="server" Text=''
                                            ...
                                            <img id="DeletService3" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_trash_(delete)_16x16_10030.gif"
                                        width="16" />
                                        </asp:LinkButton>
                ...
                <tr>
                    <td colspan="6" align="right">
                        <asp:Button ID="Add1_3" runat="server" CssClass="btn btn-success" 
                            Text="Add" OnClick="Add1_3_Click"/>
                    </td>
                </tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1_3" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modalPopup" style="padding: 10px;">
                    <div class="com_address">
                        <div class="headline" style="text-align: center">
                            <strong style="color: #593b00">เพิ่มข้อมูลงานเป็นที่ปรึกษาให้กับผู้ใช้บริการแสงซินโครตรอน / ภาคอุตสาหกรรม</strong></div>
                        <table align="center" width="100%" class="gray">
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="3">
                                    <asp:TextBox ID="txtProjectCode3" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectCode3Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectCode3"
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="3">
                                    <asp:TextBox ID="txtProjectName3" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectName3Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectName3"
                                        Display="Dynamic" SetFocusOnError="True" ValidationGroup="AddServeice1_3"></asp:RequiredFieldValidator>
                                </td>
                            </tr>      
                           ...
                           <tr> 
                            <td align="right" valign="top">
                                ...
                                <td valign="top">
                                     <asp:DropDownList ID="txtProjectClass3" runat="server" AppendDataBoundItems="True" CssClass="gray"
                                            DataSourceID="sqlClassAdd" DataTextField="ddlDisplay" DataValueField="ddlValue"
                                            Width="180" AutoPostBack="False" >
                                            <asp:ListItem Value="" >Select</asp:ListItem>
                                        </asp:DropDownList>
                                <asp:SqlDataSource ID="sqlClassAdd" runat="server" ConnectionString="<%$ ConnectionStrings:SLRIConnectionString %>"
                                    SelectCommand="SELECT id, ddlDisplay, ddlValue, ddlType  FROM MasterDDL WHERE ddlType = 'Sevice1-3-Type' ORDER BY id">
                                </asp:SqlDataSource>
                                    <asp:RequiredFieldValidator ID="reqClassAdd" runat="server" ControlToValidate="txtProjectClass3"
                                        Display="Dynamic" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="AddServeice1_3"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td align="center" colspan="6">
                                    <asp:Label ID="lblInError1_3" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="6" valign="top">
                                    <asp:Button ID="btnAddService3" runat="server" CssClass="txt_howtonav" Text="Submit"
                                        Width="100px" ValidationGroup="AddColor" OnClick="btnAddService_Click3" />
                                    <cc1:ConfirmButtonExtender ID="btnAddService3_ConfirmButtonExtender" 
                                        runat="server" ConfirmText="ยืนยันการบันทึกข้อมูล" Enabled="True" 
                                        TargetControlID="btnAddService3">
                                    </cc1:ConfirmButtonExtender>
                                    <asp:Button ID="btnCancel3" runat="server" CausesValidation="False" CssClass="txt_howtonav"
                                        Text="Cancel" Width="100px" OnClick="btnCancelService_Click3" />
                                </td>
                            </tr>
                        </table>
                    </div>
 ...
 <div>
        ...
        <ContentTemplate>
            <table align="center" width="100%">
                               ...
                               <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditSevice4" runat="server" Text=''
                                            ...
                                            <img id="editService4" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_edit_16x16_9821.gif"
                                        width="16" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                 ...
                                 <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeletService4" runat="server" Text=''
                                            ...
                                            <img id="DeletService4" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_trash_(delete)_16x16_10030.gif"
                                        width="16" />
                                        </asp:LinkButton>
                ...
                <tr>
                    <td colspan="6" align="right">
                        <asp:Button ID="Add1_4" runat="server" CssClass="btn btn-success" 
                            Text="Add" OnClick="Add1_4_Click"/>
                    </td>
                </tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1_4" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modalPopup" style="padding: 10px;">
                    <div class="com_address">
                        <div class="headline" style="text-align: center">
                            <strong style="color: #593b00">Technical manual (*มีเอกสาร contribution ด้วย)</strong></div>
                        <table align="center" width="100%" class="gray">
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="4">
                                    <asp:TextBox ID="txtProjectName4" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectName4Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectName4"
                           ...
                           <tr> 
                            <td align="right" valign="top">
                                ...
                                <td valign="top">
                                     <asp:DropDownList ID="txtProjectClass4" runat="server" AppendDataBoundItems="True" CssClass="gray"
                                            DataSourceID="sqlClass4Add" DataTextField="ddlDisplay" DataValueField="ddlValue"
                                            Width="180" AutoPostBack="False" >
                                            <asp:ListItem Value="" >Select</asp:ListItem>
                                        </asp:DropDownList>
                                <asp:SqlDataSource ID="sqlClass4Add" runat="server" ConnectionString="<%$ ConnectionStrings:SLRIConnectionString %>"
                                    SelectCommand="SELECT id, ddlDisplay, ddlValue, ddlType  FROM MasterDDL WHERE ddlType = 'Sevice1-4-Type' ORDER BY id">
                                </asp:SqlDataSource>
                                    <asp:RequiredFieldValidator ID="reqClass4Add" runat="server" ControlToValidate="txtProjectClass4"
                                        Display="Dynamic" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="AddServeice1_4"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td align="center" colspan="6">
                                    <asp:Label ID="lblInError1_4" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="6" valign="top">
                                    <asp:Button ID="btnAddService4" runat="server" CssClass="txt_howtonav" Text="Submit"
                                        Width="100px" ValidationGroup="AddColor" OnClick="btnAddService_Click4" />
                                    <cc1:ConfirmButtonExtender ID="btnAddService4_ConfirmButtonExtender" 
                                        runat="server" ConfirmText="ยืนยันการบันทึกข้อมูล" Enabled="True" 
                                        TargetControlID="btnAddService4">
                                    </cc1:ConfirmButtonExtender>
                                    <asp:Button ID="btnCancel4" runat="server" CausesValidation="False" CssClass="txt_howtonav"
                                        Text="Cancel" Width="100px" OnClick="btnCancelService_Click4" />
                                </td>
                            </tr>
                        </table>
                    </div>
 ...
 <div>
        ...
        <ContentTemplate>
            <table align="center" width="100%">
                ...
                <tr>
                    <td colspan="6" align="Left">
                        <asp:GridView ID="gvData5" runat="server" Width="900px" AllowPaging="True" OnPageIndexChanging="gvData_PageIndexChanging5"
                            AllowSorting="True" OnSorting="gvData_Sorting5" AutoGenerateColumns="False" CellPadding="4" OnRowDataBound="gvData_RowDataBound5"
                               ...
                               <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnEditSevice5" runat="server" Text=''
                                            ...
                                            <img id="editService5" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_edit_16x16_9821.gif"
                                        width="16" />
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                 ...
                                 <asp:TemplateField  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeletService5" runat="server" Text=''
                                            ...
                                            <img id="DeletService5" alt="" border="0" height="16" name="popcal" src="Images/iconfinder_trash_(delete)_16x16_10030.gif"
                                        width="16" />
                                        </asp:LinkButton>
                ...
                <tr>
                    <td colspan="6" align="right">
                        <asp:Button ID="Add1_5" runat="server" CssClass="btn btn-success" 
                            Text="Add" OnClick="Add1_5_Click"/>
                    </td>
                </tr>
                    ...
                    <div class="com_address">
                        ...
                        <table align="center" width="100%" class="gray">
                            ...
                            <tr>
                                ...
                                <td valign="top" width="150" colspan="4">
                                    <asp:TextBox ID="txtProjectName5" runat="server" CssClass="gray" Width="180px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqProjectName5Add" runat="server" ErrorMessage="*" ControlToValidate="txtProjectName5"
                           ...
                           <tr> 
                            <td align="right" valign="top">
                                ...
                                <td valign="top">
                                     <asp:DropDownList ID="txtProjectClass5" runat="server" AppendDataBoundItems="True" CssClass="gray"
                                            DataSourceID="sqlClass5Add" DataTextField="ddlDisplay" DataValueField="ddlValue"
                                            Width="180" AutoPostBack="False" >
                                            <asp:ListItem Value="" >Select</asp:ListItem>
                                        </asp:DropDownList>
                            ...
                            <tr>
                                <td align="center" colspan="6">
                                    <asp:Label ID="lblInError1_5" runat="server" Text="" ForeColor="Red"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="6" valign="top">
                                    <asp:Button ID="btnAddService5" runat="server" CssClass="txt_howtonav" Text="Submit"
                                        Width="100px" ValidationGroup="AddColor" OnClick="btnAddService_Click5" />
                                    <cc1:ConfirmButtonExtender ID="btnAddService5_ConfirmButtonExtender" 
                                        runat="server" ConfirmText="ยืนยันการบันทึกข้อมูล" Enabled="True" 
                                        TargetControlID="btnAddService5">
                                    </cc1:ConfirmButtonExtender>
                                    <asp:Button ID="btnCancel5" runat="server" CausesValidation="False" CssClass="txt_howtonav"
                                        Text="Cancel" Width="100px" OnClick="btnCancelService_Click5" />
                                </td>
                            </tr>
                        </table>
                    </div>
