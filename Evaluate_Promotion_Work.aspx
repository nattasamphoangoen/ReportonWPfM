<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Evaluate_Promotion_work.aspx.cs" Inherits="Evaluate_Promotion_work" Async="true" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <table align="center" width="768" class="gray">
                            ...
                            <tr class="lead">
                                <td colspan="6" align="center" class="txt_title_rewards">งานส่งเสริมการใช้ประโยชน์แสงซินโครตรอน</td>
                            </tr>
                            <tr>
                                <td colspan="6">&nbsp;
                                </td>
